...
switch($cat)
{
    case 1:
        ...
        break;
    case 2:
        $where = "WHERE category LIKE '%роиз%'";
        break;
    case 3:
        $where = "WHERE category LIKE '%ставки%'";
        break;
    case 4:
        $where = "WHERE category LIKE '%азработк%'";
        break;
    case 5:
        $where = "WHERE category LIKE '%мире%'";
        break;
    case 6:
        $where = "WHERE category LIKE '%азное%'";
        break;
    case 7:
        $where = "WHERE category LIKE '%рхивы%'";
        break;
    case 8:
        $where = "WHERE date LIKE '%2014%'";
        break;
    default:
        $where = "";
        break;
